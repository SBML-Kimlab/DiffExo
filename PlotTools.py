...
def make_volcano(raw_df, converted_deg_dir, result_name, test = "q-value", lfc_thr = 1.0, test_thr = 0.05, peak_names = None, lengend = True, fig_type = "svg"):
    output_dir = raw_df.output[0]
    fig_result_dir = output_dir + "plots/"+ result_name

    df = pd.read_csv(converted_deg_dir, sep = ",")    
